...
// Instantiation of Axi Bus Interface M_AXIS
	parallel_ntt_v1_0_M_AXIS # ( 
		.C_M_AXIS_TDATA_WIDTH(C_M_AXIS_TDATA_WIDTH),
		.C_M_START_COUNT(C_M_AXIS_START_COUNT)
	) parallel_ntt_v1_0_M_AXIS_inst (
