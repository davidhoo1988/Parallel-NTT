...
#
# Generated by export_simulation on Sun Feb 06 16:45:24 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './parallel_ntt_0.sh' script.

./parallel_ntt_0.sh -reset_run
...
./parallel_ntt_0.sh -noclean_files

For more information on the script, please type './parallel_ntt_0.sh -help'.
