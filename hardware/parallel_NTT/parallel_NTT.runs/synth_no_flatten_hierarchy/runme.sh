...
HD_PWD='E:/Dropbox/FHE/my project/Parallel NTT/hardware/parallel_NTT/parallel_NTT.runs/synth_no_flatten_hierarchy'
cd "$HD_PWD"
...
EAStep vivado -log parallel_ntt_0_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_ntt_0_wrapper.tcl
