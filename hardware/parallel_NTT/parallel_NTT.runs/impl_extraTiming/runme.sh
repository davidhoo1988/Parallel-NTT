...
HD_PWD='E:/Dropbox/FHE/my project/Parallel NTT/hardware/parallel_NTT/parallel_NTT.runs/impl_extraTiming'
cd "$HD_PWD"
...
EAStep vivado -log parallel_ntt_0_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parallel_ntt_0_wrapper.tcl -notrace
